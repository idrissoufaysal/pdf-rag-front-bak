...
const PDFViewer = ({ file, targetPage }: { file: File; targetPage?: number | null }) => {
  ...
  // Scrolls to the page clicked from a chat source
  useEffect(() => {
    if (targetPage == null || targetPage < 1 || !numPages || targetPage > numPages) return;
    const pageEl = pageElementsRef.current[targetPage - 1];
